...
async def pub_(bot, message):
    ...
    await send(client, user, "<b>ғᴏʀᴡᴀʀᴅɪɴɢ sᴛᴀʀᴛᴇᴅ <a href=https://t.me/anujedits76>Anuj</a></b>")
    sts.add(time=True)
    ...
    if locked:
        try:
          ...
          async for message in client.iter_messages(
            ...
            return await stop(client, user)
        temp.IS_FRWD_CHAT.remove(sts.TO)
        await send(client, user, "<b>🎉 ғᴏʀᴡᴀᴅɪɴɢ ᴄᴏᴍᴘʟᴇᴛᴇᴅ 🥀 <a href=https://t.me/anujeditbyak>SUPPORT</a>🥀</b>")
